/* Information about keys->
  Public key - c60000a60ab097172d8055b2e8adfc54
  Hash (md5) - 1749aeb772cb3f650fcf2a5e7121533e
 */
...
xhrRequest.open(
  "get",
  "https://gateway.marvel.com/v1/public/characters?ts=1&apikey=c60000a60ab097172d8055b2e8adfc54&hash=1749aeb772cb3f650fcf2a5e7121533e",
  true
);
xhrRequest.send();
...
function getUrl() {
  ...
  if (!searchQuery) {
    return "https://gateway.marvel.com/v1/public/characters?ts=1&apikey=c60000a60ab097172d8055b2e8adfc54&hash=1749aeb772cb3f650fcf2a5e7121533e";
  } else {
    return `https://gateway.marvel.com/v1/public/characters?nameStartsWith=${searchQuery}&ts=1&apikey=c60000a60ab097172d8055b2e8adfc54&hash=1749aeb772cb3f650fcf2a5e7121533e`;
  }
}
